...
const ProductCard = ({product}) => {
  return (
    ...
    <div className='mx-auto sm:h-60 sm:w-60 bg-white border-2 p-2 rounded-2xl sm:flex sm:justify-between sm:flex-col'>
     ...
     <h1 className='text-lg mt-2 ml-2'>{product.name}</h1>
     <div className='flex justify-between items-center mt-2'>
        <div className='flex ml-2'>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ">
         <path strokeLinecap="round" strokeLinejoin="round" d="M15 8.25H9m6 3H9m3 6l-3-3h1.5a3 3 0 100-6M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg><span> {product.currentPrice}</span>
        </div>
    ...
    {/*<button className=' w-24 border-1 rounded-xl p-1 shadow-inner bg-orange-300 mt-4 mx-auto '>View</button>*/}
    <Button
        sx={{
          flex: "1",
