...
def Amazon(url):
    ...
    '''
        This is the scraper function for products registered in amazon website 
        we only need to provied the url of the website it return the details of the product
...
def get_soup(url):
    '''
        This is the utility function for getting the website classes 
        pesent in the url
    '''
...
def Flipkart(url):
    '''
        ...
        This is the scraper function for products registered in flipkar website 
        we only need to provied the url of the website it return the details of the product
